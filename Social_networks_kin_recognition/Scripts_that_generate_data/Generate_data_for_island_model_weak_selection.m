...
% 'Island_weak_sel_alpha=...'. The script iterates the population genetic 
% model described in the main text and in Supp. Info. 4b (weak selection 
...
for alpha = [1 0.9999 0.9997 0.999 0.997 0.995 0.975 0.99 0.98 0.95 0.9 0.8 0.5 0]
...
pop(:,3,:,t) = pop(:,1,:,t) .* ( 1  + ... 
               ...
               (gamma .* pop(:,2,:,t) + (F-gamma) .* sum(pi.*fi)  + ...
...
% 'Island_weak_sel_alpha=...', and was used to generate Fig. 3a, Fig. 5a, 
% Fig. 5b, Fig. 5d, Supp. Fig. 12.