% INFINITE ISLAND MODEL AGENT BASED SIMULATION 

% This script generates data from the agent based simulation of the island
% model described in Supp. Info. 3c. This agent based model relaxes the 
% requirement of weak selection and mutation that featured in the 
% mathematical model. It also models deme formation accurately, without 
% requiring that deme formation is non-stochastic, unlike the mathematical 
% model. 

% The data generated from this script 
% is saved in the 'Saved_data' folder as 'strong_sel_b=3c.mat' and 
% 'strong_sel_b=9c.mat' and was used to generate Fig. S7.
...
alpha = 0.999; % Partner-reassociation probability
...
b=0.9; % Benefit of cooperation. (This value of b is used to generate the data for Fig. S7a. Alternatively setting b=2.7 can be used to generate the data for Fig. S7b.)
N=3; % Deme size 
D=167; % Number of demes in the population.
csearch = 0; % Cost of abandoning a partner and re-associating for a new social encounter.
...
% success in social interactions, and on investment in partner search).
