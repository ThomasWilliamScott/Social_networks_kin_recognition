% This script uses data generated by iterating our weak-selection 
% mathematical model described in the main text and Sup. Info. 3. The data 
% was saved in the 'Saved_data' folder. This script loads this data to 
% generate Fig. S6. Specifically, it generates the figure in four parts, 
% a-d.
...
for part = [1 2 3 4] % these four iterations generate, respectively, Supp. Fig. 6a, b, c & d.
    
    if part == 1
        load ../Saved_data/weak_sel_alpha=1.csearch=0.N=10.traitmut=0.mat

    elseif part==2
        load ../Saved_data/weak_sel_alpha=1.csearch=0.N=10.traitmut=0.001.mat

    elseif part==3
        load ../Saved_data/weak_sel_alpha=1.csearch=0.N=30.traitmut=0.mat

    elseif part==4
        load ../Saved_data/weak_sel_alpha=1.csearch=0.mat % This file stores data for the N=30, mu=0.001 case.
...
% The following two lines of code are for formatting.
colormap(gca, summer)
caxis([1 tag]);
