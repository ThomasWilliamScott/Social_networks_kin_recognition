...
% "weak_sel_alpha=...", to generate Fig. 4e (Main text). The data 
...
% following parameter values: tag = 100 (labelled L_{max} in the text); 
% N=30; T=100000; mutC = 0.001 (labelled mu_Trait in the text); tagSkewIni 
% = 0.9; b = 0.3; c = 0.1; helpini = 0.1; csearch=0; variable alpha within 
% the range 0.5 to 1.
...
% proportion of parameter space where genetic kin discrimination is stable 
% relative to the proportion of parameter space where kin discrimination is
