...
% for the following parameter values: tag = 100 (maximum tags), N=30 (deme
% size), T = 100000 (generations), mutC = 0.001 (trait mutation rate), 
% tagSkewIni = 0.9 (initial frequeny of one dominant tag), b = 0.3 
...
for aaaa = [1 2 3]
    ...
    if aaaa == 1
        load ../Saved_data/Data_Fig_3a.mat % This loads data for alpha=1, used to generate Fig. 3a.
        
    elseif aaaa == 2
        load ../Saved_data/Data_Fig_5a.mat % This loads data for alpha=0.975, used to generate Fig. 5a.
        
    elseif aaaa == 3
        load ../Saved_data/Data_Fig_5b.mat % This loads data for alpha=0, used to generate Fig. 5b.
