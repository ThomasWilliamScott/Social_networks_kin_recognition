...
% corresponding to Fig. S6a, b, c, d & e.
...
for part = [1:5] % This loop is to load data for parts a, b, c, d & e of Supp. Fig. 6 in turn.
    ...
    if part == 1
        load ../Saved_data/Simple_Fig_S6a.mat
    
    elseif part==2
        load ../Saved_data/Simple_Fig_S6b.mat
        
    elseif part==3
        load ../Saved_data/Simple_Fig_S6c.mat
        
    elseif part==4
        load ../Saved_data/Simple_Fig_S6d.mat
        
    elseif part==5
        load ../Saved_data/Simple_Fig_S6e.mat
