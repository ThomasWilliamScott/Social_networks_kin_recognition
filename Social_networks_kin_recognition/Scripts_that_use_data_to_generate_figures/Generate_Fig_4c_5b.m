...
% following range of csearch values [0 : 0.0001 : 0.0009 ] and alpha values
% [0.97, 0.999]. In order to load these data files, we enter in these
% parameter combinations.

figure % Generates the panel for Fig. 5b

% The code within the following for loop generates a single line on Fig. 
% 5b. By looping over two alpha values (0.97 & 0.999), we generate each of
% the two lines on Fig. 5b.
for alpha= [0.97 0.999] 
...
% The following 5 lines of code generate a line on Fig. 5b.
