...
% described in the main text and Sup. Info. 4b. The data was saved in the 
% 'Saved_data' folder, in four parts, as 
% 'Data_Supp_Fig_12_TraitMut=0_N=10.mat',
% 'Data_Supp_Fig_12_TraitMut=0.001_N=10.mat', 
% 'Data_Supp_Fig_12_TraitMut=0_N=30.mat',
% 'Data_Supp_Fig_12_TraitMut=0.001_N=30.mat'. This script loads this data
% to generate Supp. Info. Fig. 12. Specifically, it generates the figure in
% four parts, a-d.
...
for part = [1 2 3 4] % these four iterations generate, respectively, Supp. Fig. 12a, b, c & d.
    ...
    if part == 1
        load ../Saved_data/Data_Supp_Fig_12_TraitMut=0_N=10.mat
        
    elseif part==2
        load ../Saved_data/Data_Supp_Fig_12_TraitMut=0.001_N=10.mat
        
    elseif part==3
        load ../Saved_data/Data_Supp_Fig_12_TraitMut=0_N=30.mat

    elseif part==4
        load ../Saved_data/Data_Supp_Fig_12_TraitMut=0.001_N=30.mat
