...
% "Island_weak_sel_alpha=...", to generate Fig. 5d (Main text). The data 
% was collected by iterating the population genetic model described in the 
% main text and in Supp. Info. 4b (weak selection island model), whilst 
% assuming the following parameter values: tag = 100 (labelled L_{max} in 
% the text); N=30; T=100000; mutC = 0.001 (labelled mu_Trait in the text); 
% tagSkewIni = 0.9; b = 0.3; c = 0.1; helpini = 0.1; variable alpha within 
% the range 0.5 to 1.
...
load("../Saved_data/Island_weak_sel_alpha="+alpha+".mat")
